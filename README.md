...
To ensure the network sniffer functions correctly, you **must** run the launcher with Administrator privileges.

Open an elevated terminal (**Run as Administrator**) and execute:
...
1. Once the Master Control Panel opens, click the **🚀 START ALL** button.
